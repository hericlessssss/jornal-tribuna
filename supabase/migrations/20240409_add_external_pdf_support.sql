...
-- Create pdf_editions table with external link support
CREATE TABLE public.pdf_editions (
  ...
  source_type TEXT CHECK (source_type IN ('upload', 'google_drive', 'dropbox', 'onedrive', 'other')),
...
CREATE INDEX pdf_editions_source_type_idx ON public.pdf_editions(source_type);
